...
public class ImportContacts {
    ...
    public ArrayList<JSONObject> GetDeviceContacts(ContentResolver cr){
            ...
            while (cur.moveToNext()) {
                ...
                if (Integer.parseInt(cur.getString(cur.getColumnIndex(ContactsContract.Contacts.HAS_PHONE_NUMBER))) > 0) {
                    ...
                    while (emailCur.moveToNext()) {
                     ...
                     //   CharSequence CustomemailType = ContactsContract.CommonDataKinds.Email.getTypeLabel(cr.getResources(), type, customLabel);
